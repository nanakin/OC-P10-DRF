...
class Issue(AuthoredAndTimestamped):
    TAG_CHOICES = [("BUG", "Bug"), ("TASK", "Task"), ("FEAT", "Feature")]
    STATUS_CHOICES = [("TODO", "To Do"), ("PROG", "In Progress"), ("FINI", "Finished")]
    ...
    assigned_to = models.ForeignKey(
        to="Contributor", on_delete=models.SET_NULL, null=True, related_name="issues_assigned"
    )
